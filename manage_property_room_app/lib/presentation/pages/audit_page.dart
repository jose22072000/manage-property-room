...
final _auditRawProvider = FutureProvider<List<AuditEvent>>((ref) async {
  // Watch the version counter — invalidated whenever a board action completes.
  ref.watch(auditVersionProvider);
  // Wait until auth is ready so the token is set on the API client.
            ...
            child: SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Buscar por usuario, acción, entidad…',
